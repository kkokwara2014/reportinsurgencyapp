...
class ResolvedReportScreen extends StatefulWidget {
  const ResolvedReportScreen({super.key});

  @override
  State<ResolvedReportScreen> createState() => _ResolvedReportScreenState();
}

class _ResolvedReportScreenState extends State<ResolvedReportScreen> {
